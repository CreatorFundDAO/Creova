...
import { FaEthereum, FaUsers, FaCoins } from "react-icons/fa";
...
export default function AdminPage() {
  ...
  return (
    <Flex
      ...
      pt="64px" // Added pt="64px" to match index.js spacing
    >
      <Container maxW="container.xl" py={12} textAlign="center">
        <MotionBox initial={{ y: -50, opacity: 0 }} animate={{ y: 0, opacity: 1 }} transition={{ duration: 0.8, ease: "easeOut" }}>
          <Heading
            as="h1"
            size={{ base: "xl", md: "3xl" }} // Updated size to match index.js
            fontWeight="extrabold"
            color="white"
            lineHeight={1.3} // Added from index.js
            textShadow="0 4px 12px rgba(0, 0, 0, 0.8)" // Updated shadow to match index.js
            letterSpacing="0.5px" // Added from index.js
                      ...
                      <VStack spacing={3} align="stretch" mt={4}>
                        ...
                        <HStack spacing={3} justify="center" mt={3} wrap="wrap" gap={3}>
                          <Tooltip label="View full project details">
                            <Link href={`/projects/${campaign.id}`} passHref target="_blank" rel="noopener noreferrer">
                              <Button
                                as="a"
                                colorScheme="teal"
                                size="sm"
