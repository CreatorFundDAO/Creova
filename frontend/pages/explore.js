    ...
    <Flex direction="column" minH="100vh" bgGradient={bgGradient}>
      <Container maxW="container.xl" py={24} textAlign="center">
        ...
        >
          ...
          >
            Support innovative, community-driven projects powered by Creova’s decentralized funding.
          </Text>
        </MotionBox>
        ...
        {searchedProjects.length === 0 && (
          ...
          >
            <Text fontSize="lg" color={subTextColor}>
              No projects found. Be the first to launch your vision with Creova!
            </Text>
          </MotionBox>
        )}
      </Container>
