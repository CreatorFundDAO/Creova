  ...
  return (
    <Box pt={20} mt={24} py={10} pX={8} maxW="container.xl" mx="auto">
      ...
      <Box as="section" mb={6}>
        ...
        <Text fontSize="md" mt={2}>
          Significant amendments will be announced on our website ([insert website]) or via email/X at least 14 days before taking effect. Minor updates (e.g., clarifications) may take effect immediately.
        </Text>
        <Text fontSize="md" mt={2}>
